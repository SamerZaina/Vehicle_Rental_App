...
class RAppbarTheme {
  ...
  static AppBar lightAppBarTheme({Widget? leading , List<Widget>? actions , Widget? title ,double? leadingWidth}) => AppBar(
    title : title ?? Text(''),
    centerTitle: true,
    ...
    leadingWidth: leadingWidth ??130.w,
    leading: Padding(
  ...
  static AppBar darkAppBarTheme({Widget? leading,List<Widget>? actions,Widget? title ,double? leadingWidth}) => AppBar(
