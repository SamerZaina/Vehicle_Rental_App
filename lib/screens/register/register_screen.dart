...
import 'package:vehicle_rental_app/screens/register/agency_register.dart';
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      LoginSignButton(title: RTexts.signupBtn, onPressed: () => controller.customerRegister()),
                                      SizedBox(height: RSizes.spaceBtwItems),
                                      SecondButton(title: RTexts.loginBtn, onPressed: () => Get.off(()=>LoginScreen())),
                                      SizedBox(height: RSizes.spaceBtwItems),
                                      SecondButton(title: RTexts.agencySignupBtn, onPressed: () => Get.off(()=> AgencyRegister())),
                                    ],
                                  ),
                                ),
                              ],
