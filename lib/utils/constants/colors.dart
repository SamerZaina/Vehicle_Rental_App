...
class RColors{
  ...
  static const Color darkTeal = Color(0xFF1D546C);
  static const Color primary40 = Color(0xFF637892);
  static const Color primary70 = Color(0xFFB9C1CC);
  ...
  static const Color textFieldsColor = Color(0xFFB9C1CC);
  ...
  //Buttons Colors
  static const Color buttonPrimary = Color(0xFF0C2B4E);
